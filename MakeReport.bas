...
Dim i As Integer
Sub Makereport()
    Sheets("보고서양식").Range("A9:V150").EntireRow.Delete
    Yangsung
    Sinkyu
    EumsungDaegi
    Haeje
...
Sub Yangsung()
  ...
  For j = 0 To iIdx - 1
     vValue = rAll.Cells(rAll.Row + j - 2, 13)
     zValue = rAll.Cells(rAll.Row + j - 2, 14)
     If (vValue = "양성" And zValue = "확진") Then
        '연번
        Sheets("보고서양식").Cells(9 + i, 1) = i + 1
        Sheets("보고서양식").Cells(9 + i, 1).Interior.ColorIndex = 19
        ...
        Sheets("보고서양식").Cells(9 + i, 2).Interior.ColorIndex = 19
        ...
        Sheets("보고서양식").Cells(9 + i, 3).Interior.ColorIndex = 19
        ...
        Sheets("보고서양식").Cells(9 + i, 4).Interior.ColorIndex = 19
        ...
        Sheets("보고서양식").Cells(9 + i, 5).Interior.ColorIndex = 19
        ...
        Sheets("보고서양식").Cells(9 + i, 6).Interior.ColorIndex = 19
        ...
        Sheets("보고서양식").Cells(9 + i, 7).Interior.ColorIndex = 19
        ...
        Sheets("보고서양식").Cells(9 + i, 8).Interior.ColorIndex = 19
        ...
        Sheets("보고서양식").Cells(9 + i, 9).Interior.ColorIndex = 19
        ...
        '비고
        Sheets("보고서양식").Cells(9 + i, 11) = rAll.Cells(rAll.Row + j - 2, 11)
        Sheets("보고서양식").Cells(9 + i, 11).Interior.ColorIndex = 19
...
Sub EumsungDaegi()
  ...
  For j = 0 To iIdx - 1
    ...
    xValue = rAll.Cells(rAll.Row + j - 2, 2)
     If ((vValue = "음성" Or vValue = "대기") And wValue <> "O" And xValue <> "O") Then
        '연번
        Sheets("보고서양식").Cells(9 + i, 1) = i + 1
        Sheets("보고서양식").Cells(9 + i, 1).Borders(xlEdgeLeft).LineStyle = xlContinuous
        Sheets("보고서양식").Cells(9 + i, 1).Borders(xlEdgeRight).LineStyle = xlContinuous
